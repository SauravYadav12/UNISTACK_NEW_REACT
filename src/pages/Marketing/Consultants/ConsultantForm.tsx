    ...
    <form style={{ margin: '0 20px' }}>
      <Grid container spacing={1} sx={{ maxWidth: '100%' }}>
        ...
        <CustomSelectField
          ...
          onChange={(value: any) =>
            handleChange({ target: { value } }, 'status')
          }
          width={230}
        />
        <CustomTextField
        ...
        <CustomTextField
          ...
          onChange={(event: any) =>
            addValue('yearOfPassing', event.target.value)
          }
        />
        <CustomTextField
          label="SSN"
        ...
        <CustomTextField
          ...
          onChange={(event: any) =>
            addValue('drivingLicense', event.target.value)
          }
        />
        <CustomTextField
          ...
          onChange={(event: any) =>
            addValue('psuedoNameOfConsultant', event.target.value)
          }
        />
        <CustomTextField
          label="SkypeId"
        ...
        <CustomTextField
          ...
          onChange={(event: any) =>
            addValue('howDidYouGetTheVISA', event.target.value)
          }
        />
        <CustomTextField
          ...
          onChange={(event: any) =>
            addValue('inWhichYearYouCameToUS', event.target.value)
          }
        />
        <CustomTextField
          ...
          onChange={(event: any) =>
            addValue('basiclyFromWhichCountry', event.target.value)
          }
        />
        <CustomTextField
          ...
          onChange={(event: any) =>
            addValue('whyAreYouLookingForTheChange', event.target.value)
          }
        />
            ...
            >
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DatePicker
                  ...
                  value={
                    project.projectEndtDate
                      ? dayjs(project.projectEndtDate)
                      : null
                  }
                  onChange={(newValue) =>
                    addValue('projectEndtDate', newValue, index)
                  } // Handle date change
                  renderInput={(params) => (
                    <TextField size="small" {...params} />
                  )}
