...
import { intDurationOptions, intModeOptions, intRoundOptions, intStatusOptions, intTypeOptions, intWithOptions, meetingTypeOptions, paymentStatusOptions, resultOptions, timeZoneOptions } from './interviewValues'
          ...
          {/* Section 1: Interview Details */}
            <Grid item xs={12}>
              <h4>1. Interview Details</h4>
                ...
                onChange={(value: any)=> handleChange({ target: { value } }, "round")}
                width={230}
                />
                <CustomTextField 
